...
return [
    'relation' => [
        'conversations'       => marinaZolkina\LaravelVideoChat\Models\Conversation\Conversation::class,
        'group_conversations' => marinaZolkina\LaravelVideoChat\Models\Group\Conversation\GroupConversation::class,
    ],
    'user' => [
