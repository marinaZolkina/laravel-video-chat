...
namespace marinaZolkina\LaravelVideoChat\Repositories\Conversation;

use Carbon\Carbon;
use Illuminate\Support\Facades\File;
use marinaZolkina\LaravelVideoChat\Events\NewConversationMessage;
use marinaZolkina\LaravelVideoChat\Events\VideoChatStart;
use marinaZolkina\LaravelVideoChat\Models\Conversation\Conversation;
...
class ConversationRepository extends BaseRepository
{
    ...
    public function getAllConversations($user)
    {
        ...
        foreach ($conversations as $conversation) {
            ...
            $collection->assept = $conversation->is_accepted;
            $threads[] = $collection;
        }
